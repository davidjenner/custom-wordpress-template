...
<head>
    ...
    <meta name="author" content="https://bwrwebdesign.com">    
    <link rel="shortcut icon" href="images/logo.png"> 


    <!--   import stylesheets from functions.php  -->
    <?php
    wp_head();
    ?>
                ...
                <?php
                    wp_nav_menu(
                        array(
                            ...
                            https://wordpress.stackexchange.com/questions/111647/items-wrap-not-working
                            */
